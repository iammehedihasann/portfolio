    ...
    <section className="bg-gray-900 text-white px-6 py-16 min-h-screen">
      <div className="max-w-4xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <div className="text-center mb-10">
          <a
            href="/public/Mehedi_UpdateCV.pdf" // <-- place your resume in public folder
            download
          ...
          <div data-aos="fade-right" data-aos-duration="1000">
            ...
            <ul className="space-y-4 text-gray-300">
              <li data-aos="fade-right" data-aos-duration="1000">
                ...
                <br />
                Working on real-life web apps using React, Tailwind, and
                Firebase.
              </li>
              <li data-aos="fade-right" data-aos-duration="1000">
                <strong>Academic AI Project</strong>
                <br />
          ...
          <div data-aos="fade-left" data-aos-duration="1000">
            ...
            <ul className="space-y-4 text-gray-300">
              <li data-aos="fade-left" data-aos-duration="1000">
                <strong>B.Sc (Honours) in CSE</strong>
                <br />
                Learning MERN Stack, AI, DSA, CS Fundamentals.
              </li>
              <li data-aos="fade-left" data-aos-duration="1000">
                <strong>100 Days of Code Challenge</strong>
                <br />
