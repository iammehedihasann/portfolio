import about_image from "../assets/images/mehedi_2.jpg";
function About() {
  return (
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start justify-between gap-10">
        ...
        <div className="md:w-2/3" data-aos="fade-up" data-aos-duration="1000">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
            ...
            passionate web application developer specializing in building
            responsive, user-friendly interfaces using{" "}
            <span className="text-blue-400">React</span> and{" "}
            <span className="text-blue-400">Tailwind CSS</span>. I'm currently
            contributing at <span className="text-blue-400">BasiFy</span> and
            learning the full <span className="text-blue-400">MERN stack</span>{" "}
            along with AI development in Python.
          </p>
          ...
          <div
            ...
            data-aos-duration="1000"
          >
            <h3 className="text-xl font-semibold mb-4 text-black font-3xl">
              Tech Stack
            </h3>
